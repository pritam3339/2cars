...
var car1,
  ...
  score = 0;
var feedbacks = [
  "Good job! I hope you do even better next time",
...
var addScore = true;
//when C is at lower level set this value as 'false'
...
function checkCollission(obstacle) {
  ...
  if (obstacle.type === "rect") {
    ...
    if (
      car.x > obstacle.x - obstacle.radius &&
      car.x + car.width < obstacle.x + obstacle.radius &&
      car.y > obstacle.y - obstacle.radius &&
      car.y < obstacle.y + obstacle.radius
    ) {
      if (obstacle.status === "active") score++;
      $("#score").text("Score: " + score);
